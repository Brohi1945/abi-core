...
const WRITE_TOOLS = new Set([
  ...
  "update_order_status",
  "create_order",
  "confirm_pending_action", // delete_product ab isi ke zariye asal mein hoti hai
]);
...
- Data analyst: recent sales velocity dekh kar restock suggest karna (suggest_restock), aur suggest_related_products se upsell/cross-sell suggest karna
...
⚠️ CONFIRMATION RULE: delete_product jaisa irreversible action seedha nahi hota — delete_product call karne se woh sirf ek "proposal" banata hai aur tumhein product ka preview + pending_action_id deta hai (koi cheez delete nahi hoti). Woh preview admin ko exactly batao ("'Old Product X' ko delete karna hai — yeh wapas nahi ho sakta, confirm karein?"). Sirf jab admin apne AGLE message mein explicitly haan/confirm/yes/delete kar do kahay, tabhi confirm_pending_action ko wahi pending_action_id de kar call karo. Agar admin ne kuch aur bola ya topic badal diya, pending_action_id ko bhool jao — dobara mat use karo.
