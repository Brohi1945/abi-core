// Central registry — har domain (inventory, orders, waghera) apna tool
// module yahan register karta hai. Naya project apni tools file
// tools/ mein banaye aur ek line yahan add karay — is se zyada core
// mein kuch nahi badalna parta.
//
